...
enum PieceType {
  ...
  AMAZON, KNIBIS, BISKNI, KNIROO, ROOKNI,
  ...
  // Chesslike pieces
  // NOTE: Need to make sure don't exceed 2^PIECE_TYPE_BITS number of pieces
  // Pawn likes
  
  // Knight likes
  ELEPHANT_KNIGHT, UNICORN,
  ...
  // Custom pieces that can be user-defined in variants.ini
